...
def load_models():
    ...
    _require_file(os.path.join(LLM_MODEL_DIR, "config.json"), "T5 model dir (config.json)")
    ...
    try:
        ...
        if zip_b64:
            ...
            if not (video_b64 and json_b64):
                raise ValueError("Provide either zip_base64 OR (video_b64 and json_b64)")
        ...
        return {"error": str(e)}
# =========================================================
# RUNPOD SERVERLESS ENTRYPOINTS (NO FLASK)
# =========================================================
